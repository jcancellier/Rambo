...
lab1Mac: walk.cpp joshuaC.cpp rafaelN.cpp erikS.cpp fernandoM.cpp kuljitS.cpp
	g++ walk.cpp joshuaC.cpp rafaelN.cpp erikS.cpp fernandoM.cpp kuljitS.cpp Global.cpp SpriteSheet.cpp Timers.cpp -Wall -owalk -I/usr/X11R6/include -L/usr/X11R6/lib -lX11 -framework OpenGl -framework Cocoa -lm -lGL
